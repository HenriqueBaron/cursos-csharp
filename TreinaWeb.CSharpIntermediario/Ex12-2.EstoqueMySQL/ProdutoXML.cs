...
namespace Ex12_1.EstoqueXML
{
    public class ProdutoXML
    {
        ...
        public static List<ProdutoXML> GetProdutos()
        {
            ...
            {
                ProdutoXML produto = ProdutoXML.GetFromNode(nodeProduto);
                listaProdutos.Add(produto);
            }
            return listaProdutos;
        }

        public static void Adicionar(ProdutoXML produto)
        {
        ...
        private static XmlNode Encontrar(ProdutoXML produto, XmlDocument fonteDados)
        {
            ...
            {
                ProdutoXML produtoConvertido = GetFromNode(nodeProduto);
        ...
        private static ProdutoXML GetFromNode(XmlNode produto)
        {
